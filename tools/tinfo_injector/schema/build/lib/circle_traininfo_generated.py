...
class SGDOptions(object):
    ...
    def SGDOptionsBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x43\x54\x52\x30", size_prefixed=size_prefixed)
...
class SparseCategoricalCrossentropyOptions(object):
    ...
    def GetRootAsSparseCategoricalCrossentropyOptions(cls, buf, offset=0):
        ...
        return cls.GetRootAs(buf, offset)
    @classmethod
    def SparseCategoricalCrossentropyOptionsBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x43\x54\x52\x30", size_prefixed=size_prefixed)
...
class SparseCategoricalCrossentropyOptionsT(object):
    ...
    def Pack(self, builder):
        ...
        sparseCategoricalCrossentropyOptions = SparseCategoricalCrossentropyOptionsEnd(builder)
...
class CategoricalCrossentropyOptions(object):
    ...
    def GetRootAsCategoricalCrossentropyOptions(cls, buf, offset=0):
        ...
        return cls.GetRootAs(buf, offset)
    @classmethod
    def CategoricalCrossentropyOptionsBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x43\x54\x52\x30", size_prefixed=size_prefixed)
...
def ModelTrainingAddOptimizerOpt(builder, optimizerOpt):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(optimizerOpt), 0)
...
def ModelTrainingAddLossfnOpt(builder, lossfnOpt):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(lossfnOpt), 0)
...
class ModelTrainingT(object):
    ...
    def _UnPack(self, modelTraining):
        ...
        self.optimizerOpt = OptimizerOptionsCreator(self.optimizerOptType, modelTraining.OptimizerOpt())
        self.lossfn = modelTraining.Lossfn()
        self.lossfnOptType = modelTraining.LossfnOptType()
        self.lossfnOpt = LossFnOptionsCreator(self.lossfnOptType, modelTraining.LossfnOpt())
